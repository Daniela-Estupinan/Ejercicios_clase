...
los cuales se representan con los valores comprendidos entre 1 y 5. 
...
void main()
{
  ...
  float porcV1,porcV2,porcV3,porcV4,porcV5;
  ...
  porcV1=(voto1*100)/totalVotos;
  porcV2=(voto2*100)/totalVotos;
  porcV3=(voto3*100)/totalVotos;
  porcV4=(voto4*100)/totalVotos;
  porcV5=(voto5*100)/totalVotos;
